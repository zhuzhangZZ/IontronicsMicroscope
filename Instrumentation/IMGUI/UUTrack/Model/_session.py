"""
    ...
    It overwrites the :meth:`~UUTrack.Model._session.__setattr__` for functionality, as well as the :meth:`~UUTrack.Model._session.__str__` for handy serialization. Storing of data is done via dictionaries.

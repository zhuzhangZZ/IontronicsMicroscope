...
class CV:
    ...
    def __init__(self, Eini, Ev1, Ev2, Efin, sr, dE, nSweeps, sens, 
                 folder, fileName, header, path_lib, ExtTri, **kwargs):
        ...
        self.text = self.head + self.body3 + self.foot
...
class SSF:
    '''
        ...
        * Validate parameters
    '''
    def __init__(self, Eini, dE, dt, sens, Eswi1, Eswf1, sr1, Estep1, tstep1, Eswi2, Eswf2, sr2, folder, 
                 fileName, header, path_lib, ExtTri, **kwargs):
        print('SSF technique is still in development. Use with caution.')
        self.fileName = fileName
        self.folder = folder
        self.text = ''

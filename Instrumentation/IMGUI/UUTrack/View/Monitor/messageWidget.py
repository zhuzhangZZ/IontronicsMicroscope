...
class messageWidget(QtGui.QWidget):
    ...
    messageTitle = "Status"
    logTitle = "Log"
    logMaxLength = 50 # maximum length of the log to be displayed to the user.
    categories = {'i': 'Info',
                'e': 'Error',
                'w': 'Warning'}
    ...
    def __init__(self,parent=None):
        ...
        self.mess_logBox = QtGui.QHBoxLayout()
        ...
        self.mess_logBox.addWidget(self.message)
        self.mess_logBox.addWidget(self.log)

        self.layout.addLayout(self.statusBars)
        self.layout.addLayout(self.mess_logBox)
    ...
    def setupMessage(self):
        ...
        self.message.setFontPointSize(14)

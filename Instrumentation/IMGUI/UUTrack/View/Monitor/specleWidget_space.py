"""
    UUTrack.View.Camera.specleWidget_space.py
    ===================================
    Creates a new window that shows the (spatial) variance of the specle pattern in the center 
    of the current ROI in the image over time and some parameters like the amount 
    of oversaturated pixels in the image.
    
    Can be used instead of the time version (this requires changing the import code in monitormain)

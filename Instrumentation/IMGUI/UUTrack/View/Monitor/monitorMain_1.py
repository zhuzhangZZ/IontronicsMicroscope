...
class monitorMain(QtGui.QMainWindow):
    ...
    def updateGUI(self):
        ...
        msg = '''<b>Buffer time:</b> %0.2f ms <br />
             ...
             <b>Sensor Temperature</b> %0.2f  <br />
             <b>Frames in buffer</b> %i'''%(self.buffertime * 1000, self.fps * 1000, self.realfps, self.thismeasurementframes, self.droppedframes, self.camera.getTemp(), self.q.qsize())
    ...
    def updateSession(self, session):
        ...
        if update_cam:
            ...
            if update_exposure_unit:
                ...
                self.messageWidget.appendLog('i', 'Updated exposure unit to: %s' % new_unit)
                if self._session.Debug['to_screen']:

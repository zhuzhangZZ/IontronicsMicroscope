...
# Import data:
folder = "/home/kevin/Documents/PDSM_data/2019-02-08/"
extension = ".hdf5"
# "Easy" switch between different input files: 
# (setting all settings correct, found before, editable after taking away comments)
filenumber = 1
takenumber = 2

if filenumber == 1:
    filename = "DIwater_vpp1p6"
    
    if takenumber == 1:
        signal = "square"
        Tsignal = 1/1.  # In seconds
        Asignal = 2.6  # In volts 
        Tframe = 1/108.4  # In seconds
        oscilloscopedatafile = None
        xmin, xmax = 0, 200
        ymin, ymax = 0, 280
        xofinterest, yofinterest = 88, 189
    if takenumber == 2:
        signal = "triangle"
        Tsignal = 1/1.  # In seconds
        Asignal = 2.6  # In volts 
        Tframe = 1/108.4  # In seconds
        oscilloscopedatafile = "TEK0000.CSV"
        xmin, xmax = 0, 200
        ymin, ymax = 0, 280
        xofinterest, yofinterest = 91, 195
        
elif filenumber == 2:
    filename = "NaCl_2mM_vpp1p6"
    ...
    if takenumber == 1:
        ...
        xmin, xmax = 0, 200
        ymin, ymax = 0, 280
        xofinterest, yofinterest = 104, 30
    if takenumber == 2:
        signal = "triangle"
        Tsignal = 1/1.  # In seconds
        Asignal = 2.6  # In volts 
        Tframe = 1/108.4  # In seconds
        oscilloscopedatafile = "TEK0001.CSV"
        xmin, xmax = 0, 200
        ymin, ymax = 0, 280
        xofinterest, yofinterest = 98, 31
    if takenumber == 3:
        signal = "triangle"
        Tsignal = 1/1.  # In seconds
        Asignal = 4.  # In volts 
        Tframe = 1/108.4  # In seconds
        oscilloscopedatafile = "TEK0002.CSV"
    if takenumber == 4:
        signal = "square"
        Tsignal = 1/3.  # In seconds
        Asignal = 2.8  # In volts 
        Tframe = 1/108.4  # In seconds
        oscilloscopedatafile = "TEK0003.CSV"
        
elif filenumber == 3:
    filename = "NaCl_2mM_vpp1p6_r2"
    
    if takenumber == 1:
        signal = "triangle"
        Tsignal = 1/1.  # In seconds
        Asignal = 1.6  # In volts 
        Tframe = 1/110.  # In seconds
        oscilloscopedatafile = "TEK0004.CSV"
    if takenumber == 2:
        signal = "triangle"
        Tsignal = 1/1.  # In seconds
        Asignal = 2.8  # In volts 
        Tframe = 1/110.  # In seconds
        oscilloscopedatafile = "TEK0005.CSV"
    if takenumber == 3:  # Back to DI water
        signal = "triangle"
        Tsignal = 1/1.  # In seconds
        Asignal = 2.8  # In volts 
        Tframe = 1/110.  # In seconds
        oscilloscopedatafile = "TEK0006.CSV"
    
elif filenumber == 4:
    filename = "NaBr_2mM_vpp1p6_r2"
    ...
    if takenumber == 1:
        ...
        Asignal = 1.6  # In volts 
        Tframe = 1/110.  # In seconds
        oscilloscopedatafile = "TEK0007.CSV"
    if takenumber == 2:
        signal = "triangle"
        Tsignal = 1/1.  # In seconds
        Asignal = 1.6  # In volts 
        Tframe = 1/110.  # In seconds
        oscilloscopedatafile = "TEK0008.CSV"
    if takenumber == 3:
        signal = "triangle"
        Tsignal = 1/1.  # In seconds
        Asignal = 2.8  # In volts 
        Tframe = 1/110.  # In seconds
        oscilloscopedatafile = "TEK0009.CSV"
    if takenumber == 4:
        signal = "triangle"
        Tsignal = 1/1.  # In seconds
        Asignal = 4.  # In volts 
        Tframe = 1/110.  # In seconds
        oscilloscopedatafile = "TEK0010.CSV"
    if takenumber == 5:  # Back to DI water
        signal = "triangle"
        Tsignal = 1/1.  # In seconds
        Asignal = 2.8  # In volts 
        Tframe = 1/110.  # In seconds
    ...
    if takenumber == 1:
        ...
        Asignal = 1.6  # In volts 
        Tframe = 1/110.  # In seconds
        oscilloscopedatafile = "TEK0011.CSV"
    if takenumber == 2:
        signal = "triangle"
        Tsignal = 1/1.  # In seconds
        Asignal = 1.6  # In volts 
        Tframe = 1/110.  # In seconds
        oscilloscopedatafile = "TEK0012.CSV"
    if takenumber == 3:
        signal = "triangle"
        Tsignal = 1/1.  # In seconds
        Asignal = 2.8  # In volts 
    ...
    if takenumber == 4:
        ...
        Asignal = 2.8  # In volts 
        Tframe = 1/110.  # In seconds
        oscilloscopedatafile = "TEK0013.CSV"
    if takenumber == 5:
        signal = "triangle"
        Tsignal = 1/1.  # In seconds
        Asignal = 4.  # In volts 
        Tframe = 1/110.  # In seconds
        oscilloscopedatafile = "TEK0014.CSV"
    
elif filenumber == 6:
    filename = "TiO2particle_NaI_2mM_vpp1p6_r2"
    
    if takenumber == 1:  # Note: more background fluctuations perhaps because of floating particles
        signal = "triangle"
        Tsignal = 1/1.  # In seconds
        Asignal = 1.6  # In volts 
        Tframe = 1/160.  # In seconds
        oscilloscopedatafile = None
    if takenumber == 2:
        signal = "triangle"
        Tsignal = 1/1.  # In seconds
        Asignal = 2.8  # In volts 
        Tframe = 1/160.  # In seconds
        oscilloscopedatafile = "TEK0015.CSV"
    if takenumber == 3:
        signal = "square"
        Tsignal = 1/1.  # In seconds
        Asignal = 1.6  # In volts 
        Tframe = 1/160.  # In seconds
        oscilloscopedatafile = None
    if takenumber == 4:  # Note: flushed with NaI
        signal = "triangle"
        Tsignal = 1/1.  # In seconds
        Asignal = 2.8  # In volts 
        Tframe = 1/160.  # In seconds
        oscilloscopedatafile = "TEK0016.CSV"
    if takenumber == 5: 
        signal = "triangle"
        Tsignal = 1/1.  # In seconds
        Asignal = 4.0  # In volts 
        Tframe = 1/160.  # In seconds
        oscilloscopedatafile = "TEK0017.CSV"
    
elif filenumber == 7:
    filename = "TiO2particle_NaI_2mM_vpp1p6_r3"
    ...
    if takenumber == 2:
        signal = "square"
        Tsignal = 1/1.  # In seconds
        Asignal = 1.2  # In volts 
        Tframe = 1/160.  # In seconds
        oscilloscopedatafile = "TEK0018.CSV"
    if takenumber == 3:
        signal = "square"
        Tsignal = 1/1.  # In seconds
        Asignal = 5.  # In volts 
...
framenumber = 0
movienumber = takenumber - 1

if filenumber != 8:
    plt.imshow(data[movienumber, 1][:,:,framenumber])
    plt.show()
else:
    plt.imshow(data[movienumber, 0])
    plt.show()

#%%
# Open oscilloscopedatafile:
    """
oscilloscopedataf = open((folder+"IVcurves/"+oscilloscopedatafile), "r")
for line in oscilloscopedataf:
    words = line.split(",")
    if 
    print(words[0])
"""

...
savefolderbase = "/home/kevin/Documents/PDSM_data/2019-02-18_square-triangle/DI/"

filename = "DI-Pt"
movienumber = 2
savefolder = savefolderbase+"square-1Hz"
amovie = [folder, filename, movienumber, Tframe, Tsignal, Asignal, savefolder]
movieset.append(amovie)

filename = "DI-Pt"
movienumber = 1
savefolder = savefolderbase+"triangle-1Hz"
amovie = [folder, filename, movienumber, Tframe, Tsignal, Asignal, savefolder]
movieset.append(amovie)


savefolderbase = "/home/kevin/Documents/PDSM_data/2019-02-18_square-triangle/NaCl/"
...
savefolderbase = "/home/kevin/Documents/PDSM_data/2019-02-18_square-triangle/NaBr/"

filename = "NaBr-Ptw2"
movienumber = 3
savefolder = savefolderbase+"square-5Hz"
amovie = [folder, filename, movienumber, Tframe, Tsignal, Asignal, savefolder]
movieset.append(amovie)
...
savefolderbase = "/home/kevin/Documents/PDSM_data/2019-02-18_square-triangle/NaI/"
